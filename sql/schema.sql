...
('Grilled Chicken',    'Herb-marinated chicken breast, served with seasonal veg', 18.50, 'Mains'),
('Beef Burger',        'Angus beef patty, brioche bun, house sauce',              16.00, 'Mains'),
('Margherita Pizza',   'San Marzano tomato, fresh mozzarella, basil',             17.50, 'Mains'),
('Caesar Salad',       'Cos lettuce, croutons, parmesan, Caesar dressing',        13.00, 'Starters'),
('Spring Rolls',       'Crispy vegetable rolls, sweet chilli dipping sauce',       9.50, 'Starters'),
('Chocolate Lava Cake','Warm chocolate fondant, vanilla bean ice cream',           11.00, 'Desserts'),
('Lemonade',           'Fresh-squeezed lemonade, mint, ice',                       5.50, 'Drinks'),
('Flat White',         'Double shot espresso, steamed whole milk',                  4.50, 'Drinks');
